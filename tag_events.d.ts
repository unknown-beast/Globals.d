...
declare namespace TagEvent {
    ...
    class TransformerSerializer extends Internal.TagEventJS {
    get(id: Special.TransformerSerializerTag): Internal.TagWrapper
    add(tag: Special.TransformerSerializerTag, ...id: Special.TransformerSerializer[]): Internal.TagWrapper
    remove(tag: Special.TransformerSerializerTag, ...id: Special.TransformerSerializer[]): Internal.TagWrapper
    removeAll(tag: Special.TransformerSerializerTag): Internal.TagWrapper
    removeAllTagsFrom(...id: Special.TransformerSerializer[]): Internal.TagWrapper
    }
    class ConditionSerializer extends Internal.TagEventJS {
    get(id: Special.ConditionSerializerTag): Internal.TagWrapper
    add(tag: Special.ConditionSerializerTag, ...id: Special.ConditionSerializer[]): Internal.TagWrapper
    remove(tag: Special.ConditionSerializerTag, ...id: Special.ConditionSerializer[]): Internal.TagWrapper
    removeAll(tag: Special.ConditionSerializerTag): Internal.TagWrapper
    removeAllTagsFrom(...id: Special.ConditionSerializer[]): Internal.TagWrapper
    }
