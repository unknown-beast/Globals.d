...
declare namespace Registry {
    ...
    class Brews extends Internal.RegistryEventJS {
    ...
    class Keytypes extends Internal.RegistryEventJS {
    }
    ...
    class SlabfishCondition extends Internal.RegistryEventJS {
    }
    class ItemModifiers extends Internal.RegistryEventJS {
    }
    ...
    class PlantRecollectable extends Internal.RegistryEventJS {
    }
    class Straw extends Internal.RegistryEventJS {
    }
    class Module extends Internal.RegistryEventJS {
    }
    class RobitSkin extends Internal.RegistryEventJS {
    }
    class JsonConditions extends Internal.RegistryEventJS {
    }
    class Perks extends Internal.RegistryEventJS {
    }
    class DwarfRabbitVariant extends Internal.RegistryEventJS {
    }
    class TinyBirdVariant extends Internal.RegistryEventJS {
    }
    class StructureHeightProviderTypes extends Internal.RegistryEventJS {
    }
    class TransformerSerializer extends Internal.RegistryEventJS {
    }
    class ConditionSerializer extends Internal.RegistryEventJS {
    }
}