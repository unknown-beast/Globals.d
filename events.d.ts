...
declare const IronsSpellsEvents: {
};
...
chestOpened(handler: (event: Internal.ChestEventJS) => void):void,
     ...
     * @cancellable
    */
spellPreCast(handler: (event: Internal.SpellPreCastEventJS) => void):void,
    /**
     * @at *server*
    */
loggedOut(handler: (event: Internal.SimplePlayerEventJS) => void):void,
     ...
     * @at *server, client*
    */
spellSelection(handler: (event: Internal.SpellSelectionEventJS) => void):void,
    /**
     * @at *server, client*
    */
...
inventoryOpened(handler: (event: Internal.InventoryEventJS) => void):void,
     ...
     * @at *server*
    */
spellOnCast(handler: (event: Internal.SpellOnCastEventJS) => void):void,
    /**
     * @at *server*
     * 
     * @cancellable
    */
changeMana(handler: (event: Internal.ChangeManaEventJS) => void):void,
};
...
registry(type: "environmental:slabfish_condition", handler: (event: Registry.SlabfishCondition) => void):void,
registry(type: "forbidden_arcanus:item_modifiers", handler: (event: Registry.ItemModifiers) => void):void,
...
registry(type: "twilightforest:dwarf_rabbit_variant", handler: (event: Registry.DwarfRabbitVariant) => void):void,
registry(type: "twilightforest:tiny_bird_variant", handler: (event: Registry.TinyBirdVariant) => void):void,
registry(type: "valhelsia_structures:structure_height_provider_types", handler: (event: Registry.StructureHeightProviderTypes) => void):void,
registry(type: "crafttweaker:transformer_serializer", handler: (event: Registry.TransformerSerializer) => void):void,
registry(type: "crafttweaker:condition_serializer", handler: (event: Registry.ConditionSerializer) => void):void,
    /**
     * @at *startup*
    */
